...
@implementation ISGroupListTableCell
...
//    [self.myContentView addGestureRecognizer:self.panRecognizer];
    ...
    self.imgUserPicture.layer.cornerRadius = self.self.imgUserPicture.layer.frame.size.width/2;
    ...
    switch (recognizer.state) {
        ...
        case UIGestureRecognizerStateEnded:
            if (self.startingRightLayoutConstraintConstant == 0) { //1
                //We were opening
                CGFloat halfOfButtonOne = 65 / 2; //2
                ...
                //We were closing
                CGFloat buttonOnePlusHalfOfButton2 = 54 / 2; //4
